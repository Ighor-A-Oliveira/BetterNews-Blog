...
export default function Card({article}) {
  ...
  return (
    ...
    >
      <Link to={`http://localhost:5173/artigo/${article.id}`}>
        <div className="absolute h-[50%] w-full z-20 bottom-0 left-0 bg-gradient-to-b from-black/5 to-black/80 hover:from-black/20 hover:to-black/100 p-1 transition-shadow duration-300">
